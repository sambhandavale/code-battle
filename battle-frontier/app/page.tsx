...
import { Play, Zap, Terminal, Code2, Clock, Swords } from 'lucide-react';
...
const Navbar = () => (
  <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto border-b border-slate-100/50">
    ...
    <div className="hidden md:flex items-center gap-8 text-slate-500 font-medium text-sm">
      <a href="#" className="hover:text-blue-600 transition">Lobby</a>
    ...
    <div className="flex items-center gap-4">
      <div className="text-right hidden sm:block">
        <p className="text-xs font-bold text-slate-800">Orlando Diggs</p>
        <p className="text-[10px] text-slate-500">ELO 1540</p>
      </div>
      <div className="w-9 h-9 bg-slate-200 rounded-full overflow-hidden border-2 border-white shadow-sm">
        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Orlando" alt="User" />
      </div>
    </div>
  </nav>
);
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100">
      ...
      <main className="pt-12 pb-24 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-3 py-1 mb-6 animate-fade-in-down">
             <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
             <span className="text-xs font-bold text-slate-600 tracking-wide uppercase">Live Battles • 1,204 Online</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6">
            Compete. Code. <br className="hidden md:block" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button 
              ...
              className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-3.5 rounded-xl font-bold transition shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2">
              <Swords size={18} />
              Find Match
            </button>
            {/* <button className="w-full sm:w-auto bg-white border border-slate-200 hover:border-slate-300 text-slate-700 px-8 py-3.5 rounded-xl font-bold transition flex items-center justify-center gap-2">
              <Code2 size={18} />
              Practice Arena
            </button> */}
          </div>
